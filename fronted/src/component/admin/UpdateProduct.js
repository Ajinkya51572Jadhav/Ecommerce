...
//           console.log("update productId",productId ,"myform", myForm);
...
//            <div>
//             <DescriptionIcon/>
//             <textarea cols={"30"} rows={"1"} placeholder="Product Description" value={description} required onChange={(e)=>setDescription(e.target.value)} />
//            </div>
...
//              <div>
//              <StorageIcon/>
//             <input type="number" required placeholder="Stock" value={Stock} onChange={(e)=>setStock(e.target.value)}/>  
//              </div>
...
const UpdateProduct = () => {
  ...
  const updateProductSubmitHandler = (e) => {
    ...
    const myForm = new FormData();
 console.log(myForm.set("name", name))
    myForm.set("name", name);
    myForm.set("price", price);
    myForm.set("description", description);
    myForm.set("category", category);
    ...
    console.log("productId, myForm" , productId, myForm);
    dispatch(updateProduct(productId, myForm));
  };
  ...
  }, [ dispatch,navigate,  alert,   error,    isUpdated,    productId,    product,    updateError,  ]);
